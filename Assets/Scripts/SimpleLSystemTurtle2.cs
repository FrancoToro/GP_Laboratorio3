...
public class SimpleLSystemTurtle2 : MonoBehaviour
{
    ...
    [SerializeField] public string axiom = "F"; // Inicio
    [SerializeField] private string rule = "F[+F]F[-F]F"; // Regla con ramas

    [Header("Generaciones")]
    [SerializeField, Range(1, 6)] public int minGenerations = 1;
    [SerializeField, Range(1, 6)] public int maxGenerations = 10;
    ...
    private void DrawSentence()
    {
        ...
        float currentAngle = 90f; // Empieza hacia arriba
        ...
        foreach (char c in currentSentence)
        {
            switch (c)
            {
                ...
                case ']':
                    ...
                    points.Add(position); // reconecta desde esta rama
                    break;
            }
        }
